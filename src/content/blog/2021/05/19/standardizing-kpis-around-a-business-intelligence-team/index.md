...
![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2021/05/image-1024x982.png)

_An Example BI Team Scorecard using the new Goals in Power BI_
...
![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2021/05/image-4.png)

_Viewing Report Usage on a 30 Day Rolling Basis_
...
![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2021/05/image-1.png)

_Using Customer Voice to Send out Report Feedback Surveys using Variables for Report Name_
...
![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2021/05/image-3.png)

_An Example of Report Refresh KPIs_
...
![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2021/05/image-2.png)

_Flagging a Report with 40 Days since being viewed by User_
...
This may be obvious, but a prerequisite of creating and using KPI’s is having the data. So where is this data coming from? If you are a Power BI Administrator in your tenant, you can import the data via PowerShell. [Install the Power BI Module in PowerShell](https://www.powershellgallery.com/packages/MicrosoftPowerBIMgmt/1.0.974) using the following command:
...
The script above collects activity data from your tenant and creates a CSV file per day. Note that this can only go back 30 days – make sure you run this on a weekly basis and change the variables. To learn more about what else you can do with the PowerShell cmdlets for Power BI, [read the announcement from the Power Blog here.](https://powerbi.microsoft.com/en-us/blog/announcing-apis-and-powershell-cmdlets-for-power-bi-administrators/)

To collect refresh statistics, [Marc Lelijveld (Data-Marc) has a great tutorial here.](https://data-marc.com/2021/01/07/extract-refresh-metrics-for-your-entire-power-bi-workspace/)
...
Like the content here? Then you will love the Explicit Measures Podcast!  Subscribe to the [Podcast on Spotify](https://open.spotify.com/show/230fp78XmHHRXTiYICRLVv), [Apple](https://podcasts.apple.com/us/podcast/explicit-measures-podcast/id1568944083) or [multiple platforms on Anchor](https://anchor.fm/explicitmeasures). Want to join us live? We stream every episode on [YouTube Tuesdays and Thursdays at 7:30 am CST](https://www.youtube.com/playlist?list=PLn1m_aBmgsbHr83c1P6uqaWF5PLdFzOjj). You can also subscribe to [new events on the PowerBI.tips LinkedIn Page](https://www.linkedin.com/company/powerbitips/events/)
