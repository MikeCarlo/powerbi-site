...
#### Introducing [Lingo, the free linguistics code editor](https://github.com/PowerBI-tips/website-downloads/tree/main/lingo).[![Introducing Lingo](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2018/04/Lingo.png)](https://powerbi.tips/lingo/)
...
For the full details on the linguistics schema visit the [following article from Microsoft](https://powerbi.microsoft.com/en-us/blog/editing-q-a-linguistic-schemas/).  A sample Power BI file, Linguistics model, and Linguistics Spec can be [downloaded here](https://go.microsoft.com/fwlink/?linkid=871858).  Well that about wraps it up, thanks for reading and happy coding.

If you like what you learned about today and want to stay updated, please follow me on [Twitter](https://powerbi.tips/lingo/), [Linkedin](https://www.linkedin.com/in/michaelcarlo/), and [YouTube](https://www.youtube.com/channel/UCPwPrIpZwlfIKcoUpRwl9OQ) for the latest updates.
