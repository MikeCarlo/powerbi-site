...
*   10 pages of different layouts – _Unbranded_
*   5 pages with navigation built with buttons in the report (Easily swap out a different background)
*   10 PNG images of all the backgrounds to use in this report or others – _Unbranded_
...
*   No PowerBI.Tips Branding on any of the main report pages – _Unbranded_

![](https://powerbitips03.blob.core.windows.net/blobpowerbitips03/wp-content/uploads/2019/08/Instructions-1024x579.png)
