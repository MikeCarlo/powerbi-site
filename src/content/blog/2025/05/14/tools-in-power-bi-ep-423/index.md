...
- [Manage Connections for Shortcuts](https://blog.fabric.microsoft.com/blog/manage-connections-for-shortcuts/?WT.mc_id=DP-MVP-5002621) — Microsoft announced a new manage connections experience for OneLake shortcuts. You can now view all shared cloud connections used by shortcuts in a lakehouse, see how many shortcuts use each connection, and bulk-replace connections when a user leaves or credentials change. This makes shortcut management significantly easier at scale.

- [Shortcut Cache and On-Prem Gateway Support Now GA](https://blog.fabric.microsoft.com/blog/shortcut-cache-and-on-prem-gateway-support-now-generally-available/?WT.mc_id=DP-MVP-5002621) — Cross-cloud shortcut caching and on-premises gateway support for shortcuts are now generally available. The cache retention period is now configurable from 1–28 days (previously fixed at 24 hours), helping reduce egress fees from AWS and GCP sources. On-prem gateway support enables secure hybrid-cloud scenarios for shortcut data access.

- [Copilot for SQL Analytics Endpoint in Microsoft Fabric (Preview)](https://blog.fabric.microsoft.com/blog/announcing-copilot-for-sql-analytics-endpoint-in-microsoft-fabric?ft=All&WT.mc_id=DP-MVP-5002621) — Microsoft introduced an AI-powered Copilot for the SQL Analytics Endpoint in Fabric. Users can express queries in natural language and receive ready-to-run T-SQL that works across Lakehouses, Warehouses, and mirrored databases. It's designed to accelerate the path from question to insight across your entire Fabric data estate.
