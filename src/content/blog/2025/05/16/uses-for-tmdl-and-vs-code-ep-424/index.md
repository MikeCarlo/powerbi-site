...
- **[Orchestrate your Databricks Jobs with Fabric Data pipelines | Microsoft Fabric Blog | Microsoft Fabric](https://blog.fabric.microsoft.com/en-US/blog/orchestrate-your-databricks-jobs-with-fabric-data-pipelines//)** — We’re excited to announce that you can now orchestrate Azure Databricks Jobs from your Microsoft Fabric data pipelines! Databrick Jobs allow you to schedule and orchestrate a task or multiple tasks in a workflow in...
